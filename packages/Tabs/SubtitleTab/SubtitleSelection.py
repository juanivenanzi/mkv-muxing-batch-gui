...
class SubtitleSelectionSetting(QGroupBox):
    ...
    is_there_old_files_signal = Signal(bool)from PySide6.QtCore import Signal
from PySide6.QtWidgets import (
    QGroupBox,
)
...
class SubtitleSelectionSetting(QGroupBox):
    ...
    def create_widgets(self):
        self.subtitle_source_label = QLabel("Carpeta de origen de subtítulos:")
        ...
        self.subtitle_match_groupBox = QGroupBox("Coincidencia de subtítulos")
    ...
    def update_files_with_drag_and_drop(self, paths_list):
        ...
        self.subtitle_source_lineEdit.stop_check_path = False
        if duplicate_flag:
            info_message = "Uno o más archivos tienen el mismo nombre que los archivos antiguos y serán omitidos:"
            for file_name in duplicate_files_list:
                info_message += "\n" + file_name
            warning_dialog = WarningDialog(window_title="Nombres de archivos duplicados", info_message=info_message,
                                           parent=self.window())
