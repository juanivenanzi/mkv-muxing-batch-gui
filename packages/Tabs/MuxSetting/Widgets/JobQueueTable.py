...
class JobQueueTable(TableWidget):
    ...
    def setup_columns(self):
        ...
        column = QTableWidgetItem("Subtítulo")
        column.setTextAlignment(Qt.AlignmentFlag.AlignCenter)
        self.setHorizontalHeaderItem(self.column_ids["Subtitle"], column)

        column = QTableWidgetItem("Capítulo")
        column.setTextAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        column = QTableWidgetItem("Progreso")
        column.setTextAlignment(Qt.AlignmentFlag.AlignLeft)
    ...
    def set_row_value_chapter(self, new_job, new_row_id):
        if len(GlobalSetting.CHAPTER_FILES_LIST) > new_row_id:
            ...
            self.setCellWidget(
                new_row_id,
                self.column_ids["Chapter"],
                WarningCell(tool_tip="Sin archivo de capítulo"),
            )
    ...
    def set_row_value_subtitle(self, new_job, new_row_id):
        ...
        if subtitles_count == 1:
            ...
            self.setCellWidget(
                new_row_id,
                self.column_ids["Subtitle"],
                WarningCell(tool_tip="Sin archivo de subtítulo"),
            )
        else:
            new_job.subtitle_found = True
            self.setCellWidget(
    ...
    def set_row_value_audio(self, new_job, new_row_id):
        ...
        if audios_count == 1:
            ...
            self.setCellWidget(
                new_row_id,
                self.column_ids["Audio"],
                WarningCell(tool_tip="Sin archivo de audio"),
            )
        else:
            new_job.audio_found = True
            self.setCellWidget(
    ...
    def set_job_status_bad(self, row_index):
        ...
        self.setCellWidget(
            ...
            ErrorCell(tool_tip="Ocurrió un error\nDoble clic para más detalles"),
        )
