...
class PresetTabWidget(QWidget):
    def __init__(self, options):
        ...
        self.default_audio_extensions_layout = DefaultExtensionsLayout(
            label_name="Extensiones de audio: ",
    ...
    def setup_default_directories_groupBox(self):
        ...
        self.default_directories_groupBox.setTitle("Directorios predeterminados")
    ...
    def setup_default_extensions_groupBox(self):
        ...
        self.default_extensions_groupBox.setTitle("Extensiones predeterminadas")
    ...
    def setup_default_languages_groupBox(self):
        ...
        self.default_languages_groupBox.setTitle("Lista de idiomas favoritos")
