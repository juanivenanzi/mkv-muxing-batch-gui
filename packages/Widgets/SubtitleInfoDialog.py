...
class SubtitleInfoDialog(MyDialog):
    def __init__(
        ...
        self.subtitle_name_label = QLabel("Nombre del subtítulo:")
        ...
        self.subtitle_delay_label = QLabel("Retraso del subtítulo:")
        self.subtitle_delay_spin = QDoubleSpinBox()
        self.setup_subtitle_delay_spin()

        self.subtitle_language_label = QLabel("Idioma del subtítulo:")
        ...
        self.subtitle_set_forced_label = QLabel("Estado forzado del subtítulo:")
        self.subtitle_set_forced_checkBox = QCheckBox()
        self.setup_subtitle_set_forced_checkBox()

        self.subtitle_set_default_label = QLabel("Estado predeterminado del subtítulo:")
    ...
    def setup_subtitle_set_default_checkBox(self):
        self.subtitle_set_default_checkBox.setText("Establecer como predeterminado")
    ...
    def setup_subtitle_set_forced_checkBox(self):
        self.subtitle_set_forced_checkBox.setText("Establecer como forzado")
